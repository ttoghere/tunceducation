...
import 'package:tunceducation/core/common/widgets/reactive_button.dart';
...
import 'package:tunceducation/core/extensions/string_extensions.dart';
...
import 'package:tunceducation/src/course/features/videos/data/models/video_model.dart';
import 'package:tunceducation/src/course/features/videos/presentation/cubit/video_cubit.dart';
import 'package:tunceducation/src/course/features/videos/presentation/utils/video_utils.dart';
...
class _AddVideoViewState extends State<AddVideoView> {
  ...
  final authorController = TextEditingController(text: 'tunckanklc2624');
  ...
  void reset() {
    setState(() {
      urlController.clear();
      authorController.text = 'tunckanklc2624';
